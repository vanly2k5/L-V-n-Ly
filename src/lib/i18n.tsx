...
const translations = {
  vi: {
    ...
    events: {
      ...
      categories: ["Tất cả", "Học thuật", "Tình nguyện", "Thể thao", "CLB", "Xã hội"],
      scholarshipCategories: ["Tất cả", "Khuyến khích (GPA)", "Doanh nghiệp", "Quốc tế & Trao đổi", "Hỗ trợ & Vượt khó", "Tài năng & Nghiên cứu"],
  ...
  en: {
    ...
    events: {
      ...
      categories: ["All", "Academic", "Volunteer", "Sports", "Club", "Social"],
      scholarshipCategories: ["All", "Academic GPA", "Corporate", "Int'l & Exchange", "Need-based", "Talent & Research"],
